...
class ComplianceWidget extends StatefulWidget {
  @override
  _ComplianceWidgetState createState() => _ComplianceWidgetState();
}

class _ComplianceWidgetState extends State<ComplianceWidget> {
