...
class WalletCryptoWidget extends StatefulWidget {
  @override
  _WalletCryptoWidgetState createState() => _WalletCryptoWidgetState();
}

class _WalletCryptoWidgetState extends State<WalletCryptoWidget> {
