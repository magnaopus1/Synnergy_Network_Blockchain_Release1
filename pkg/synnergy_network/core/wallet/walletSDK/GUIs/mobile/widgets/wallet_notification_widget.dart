...
class WalletNotificationWidget extends StatefulWidget {
  @override
  _WalletNotificationWidgetState createState() => _WalletNotificationWidgetState();
}

class _WalletNotificationWidgetState extends State<WalletNotificationWidget> {
