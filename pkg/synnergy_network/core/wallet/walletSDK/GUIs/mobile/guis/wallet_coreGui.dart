...
class WalletCoreGui extends StatefulWidget {
  @override
  _WalletCoreGuiState createState() => _WalletCoreGuiState();
}

class _WalletCoreGuiState extends State<WalletCoreGui> {
  ...
  Future<void> loadWalletMetadata(String filePath, String encryptionKey) async {
    ...
    if (response.statusCode == 200) {
      ...
      // Display or use the loaded metadata
    } else {
