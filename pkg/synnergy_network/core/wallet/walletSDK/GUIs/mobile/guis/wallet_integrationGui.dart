...
class WalletIntegrationGui extends StatefulWidget {
  @override
  _WalletIntegrationGuiState createState() => _WalletIntegrationGuiState();
}

class _WalletIntegrationGuiState extends State<WalletIntegrationGui> {
