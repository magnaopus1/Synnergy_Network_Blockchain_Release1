...
// Syn721Token represents a SYN721 token with its metadata, ownership, and valuation details
...
// Syn721TokenTracker manages SYN721 tokens and tracks their metadata, ownership, and valuation changes
