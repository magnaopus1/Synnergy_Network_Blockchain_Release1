...
type StorageInterface interface {
	StoreData(data []byte, passphrase string) (string, string, error)
	RetrieveData(hash, passphrase, salt string) ([]byte, error)
	ArchiveData(data []byte, filePath string) error
	RetrieveArchivedData(filePath string) ([]byte, error)
}
