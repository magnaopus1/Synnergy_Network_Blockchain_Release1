...
def custom_deployment(new_model_path, deployment_notes):
    """Function to handle the custom deployment of the AI conversation bot model."""
    logger.info("Starting custom deployment process...")
    ...
    logger.info("Custom deployment process completed successfully.")
...
if __name__ == '__main__':
    ...
    custom_deployment(new_model_path, deployment_notes)
