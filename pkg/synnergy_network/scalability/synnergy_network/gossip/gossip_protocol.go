...
// GossipMessage represents a message exchanged in the gossip protocol.
...
// GossipNode represents a node participating in the gossip protocol.
type GossipNode struct {
	Address string
}

// GossipProtocol manages the gossip protocol for message dissemination across nodes.
type GossipProtocol struct {
	...
	receiveCh   chan GossipMessage
	broadcastCh chan GossipMessage
}
...
func NewGossipProtocol(passphrase string) (*GossipProtocol, error) {
	...
	return &GossipProtocol{
		...
		receiveCh:   make(chan GossipMessage),
		broadcastCh: make(chan GossipMessage),
	}, nil
}
...
func (gp *GossipProtocol) AddNode(address string) {
	...
	gp.nodes = append(gp.nodes, GossipNode{Address: address})
}
...
func (gp *GossipProtocol) sendMessageToNode(address string, msg GossipMessage) {
