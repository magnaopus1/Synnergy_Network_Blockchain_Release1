...
func GenerateRicardianContract(legalTerms, smartContractCode, privateKey string, parameters map[string]string) (*RicardianContract, error) {
...
func ExampleUsage() {
	...
	contract, err := GenerateRicardianContract(legalTerms, smartContractCode, privateKey, parameters)
	if err != nil {
